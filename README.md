...
- **OneDrive Integration**: Connect to Microsoft OneDrive to browse and display images from cloud storage.
- **OAuth Authentication**: Secure authentication with Microsoft accounts.
...
To enable OneDrive integration for cloud-based image browsing:

1. Follow the detailed setup guide in [ONEDRIVE_SETUP.md](./ONEDRIVE_SETUP.md)
